...
! local variables
  ...
  g3 = c(3)
  a = c(4)
  mu1ddd = a*g1*(crddd*sr+crdd*srd1+crdd0*srd0+crd*srd0d+crd0d*srd+crd0*&
&   srdd0+crd1*srdd+cr*srddd) + (g2-g3)*((ctddd*st+ctdd*std1+ctdd0*std0+&
&   ctd*std0d+ctd0d*std+ctd0*stdd0+ctd1*stdd+ct*stddd)*sr+(ctdd*st+ctd*&
&   std0+ctd0*std+ct*stdd)*srd1+(ctdd0*st+ctd*std1+ctd1*std+ct*stdd0)*&
&   srd0+(ctd*st+ct*std)*srd0d+(ctd0d*st+ctd0*std1+ctd1*std0+ct*std0d)*&
&   srd+(ctd0*st+ct*std0)*srdd0+(ctd1*st+ct*std1)*srdd+ct*st*srddd) - a*&
&   ((g2*2*(ctd0d*ctd+ctd0*ctdd0+ctd1*ctdd+ct*ctddd)+g3*2*(std0d*std+&
&   std0*stdd0+std1*stdd+st*stddd))*cr*sr+(g2*2*(ctd0*ctd+ct*ctdd)+g3*2*&
&   (std0*std+st*stdd))*(crd1*sr+cr*srd1)+(g2*2*(ctd1*ctd+ct*ctdd0)+g3*2&
...
&   srd0+crd0*srd+cr*srdd))
  mu1dd0 = a*g1*(crdd0*sr+crd*srd1+crd1*srd+cr*srdd0) + (g2-g3)*((ctdd0*&
&   st+ctd*std1+ctd1*std+ct*stdd0)*sr+(ctd*st+ct*std)*srd1+(ctd1*st+ct*&
&   std1)*srd+ct*st*srdd0) - a*((g2*2*(ctd1*ctd+ct*ctdd0)+g3*2*(std1*std&
&   +st*stdd0))*cr*sr+(g2*2*ct*ctd+g3*2*st*std)*(crd1*sr+cr*srd1)+(g2*2*&
&   ct*ctd1+g3*2*st*std1)*(crd*sr+cr*srd)+(g2*ct**2+g3*st**2)*(crdd0*sr+&
&   crd*srd1+crd1*srd+cr*srdd0))
  mu1d = a*g1*(crd*sr+cr*srd) + (g2-g3)*((ctd*st+ct*std)*sr+ct*st*srd) -&
&   a*((g2*2*ct*ctd+g3*2*st*std)*cr*sr+(g2*ct**2+g3*st**2)*(crd*sr+cr*&
&   srd))
  mu1d0d = a*g1*(crd0d*sr+crd0*srd1+crd1*srd0+cr*srd0d) + (g2-g3)*((&
&   ctd0d*st+ctd0*std1+ctd1*std0+ct*std0d)*sr+(ctd0*st+ct*std0)*srd1+(&
&   ctd1*st+ct*std1)*srd0+ct*st*srd0d) - a*((g2*2*(ctd1*ctd0+ct*ctd0d)+&
&   g3*2*(std1*std0+st*std0d))*cr*sr+(g2*2*ct*ctd0+g3*2*st*std0)*(crd1*&
&   sr+cr*srd1)+(g2*2*ct*ctd1+g3*2*st*std1)*(crd0*sr+cr*srd0)+(g2*ct**2+&
&   g3*st**2)*(crd0d*sr+crd0*srd1+crd1*srd0+cr*srd0d))
